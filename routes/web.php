...
Route::get('circle/thread/favorite', 'Circle\CircleThreadController@threadFavorite')->name('circle.thread.favorite');
Route::get('circle/thread/unfavorite', 'Circle\CircleThreadController@threadUnfavorite')->name('circle.thread.unfavorite');
...
Route::post('circle/thread/register/store', 'Circle\CircleThreadController@threadStore')->name('circle.thread.register.store');
Route::get('circle/thread/delete', 'Circle\CircleThreadController@threadDelete')->name('circle.thread.delete');
Route::get('circle/thread/freshman', 'Circle\CircleThreadController@threadFreshman')->name('circle.thread.freshman');
...
Route::get('circle/thread/message/delete', 'Circle\CircleThreadController@messageDelete')->name('circle.thread.message.delete');
