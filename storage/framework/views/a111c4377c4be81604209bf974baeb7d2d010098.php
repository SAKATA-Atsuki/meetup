...
<body>
    ...
    <div class="circle_mypage_email_auth_content">
        <form action="<?php echo e(route('circle.mypage.email.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>メールアドレス変更</h1>
            <div class="form">
                <div class="left">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/circle/mypage/auth.blade.php ENDPATH**/ ?>