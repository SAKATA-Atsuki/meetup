...
<body>
    ...
    <div class="admin_form_content">
        <form action="<?php echo e(route('admin.circle.register.check')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>サークル登録</h1>
            <div class="form">
                <div class="left">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/circle/register.blade.php ENDPATH**/ ?>