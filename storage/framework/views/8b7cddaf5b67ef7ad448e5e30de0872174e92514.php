...
<body>
    ...
    <div class="admin_check_content">
        ...
        <div class="button">
            <form action="<?php echo e(route('admin.campus.edit.update')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/campus/checkEdit.blade.php ENDPATH**/ ?>