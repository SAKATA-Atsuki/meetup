...
<body>
    ...
    <div class="admin_check_content">
        <form action="<?php echo e(route('admin.freshman.delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>新入生削除</h1>
            <p>本当に削除しますか？</p>
            <div class="button">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/freshman/delete.blade.php ENDPATH**/ ?>