...
<body>
    ...
    <div class="freshman_mypage_email_edit_content">
        <form action="<?php echo e(route('freshman.mypage.email.send')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>メールアドレス変更</h1>
            <div class="form">
                <div class="left">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/freshman/mypage/email.blade.php ENDPATH**/ ?>