...
<body>
    ...
    <div class="admin_check_content">
        <form action="<?php echo e(route('admin.thread.delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>スレッド削除</h1>
            <p>本当に削除しますか？</p>
            <div class="button">
                ...
                <br><br>
                <a href="<?php echo e(route('admin.thread', ['page' => $data['page'], 'order' => $data['order']])); ?>" class="button_2">スレッド一覧へ</a>    
            </div>    
        </form>
    </div>
</body>
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/thread/delete.blade.php ENDPATH**/ ?>