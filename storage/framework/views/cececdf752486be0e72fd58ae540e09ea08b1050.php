...
<body>
    ...
    <div class="circle_password_reset_content">
        <form action="<?php echo e(route('circle.password.email')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>パスワードリセット</h1>
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/circle/auth/passwords/email.blade.php ENDPATH**/ ?>