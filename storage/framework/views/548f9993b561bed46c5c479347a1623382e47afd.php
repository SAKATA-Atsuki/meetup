...
<body>
    ...
    <div class="freshman_password_reset_content">
        <form action="<?php echo e(route('freshman.password.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>パスワードリセット</h1>
            <div class="form">
                <div class="left">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/freshman/auth/passwords/reset.blade.php ENDPATH**/ ?>