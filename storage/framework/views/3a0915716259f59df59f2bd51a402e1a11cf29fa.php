...
<body>
    ...
    <div class="admin_form_content">
        <form action="<?php echo e(route('admin.circle.edit.check')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>サークル編集</h1>
            <div class="form">
                <div class="left">
...
unset($__errorArgs, $__bag); ?>    
            ...
            <div class="form">
                ...
                <div class="right">
                    <input type="text" name="email" value="<?php if(old('email') == null): ?><?php echo e($circle['email']); ?><?php else: ?><?php echo e(old('email')); ?><?php endif; ?>" size="39">
...
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/circle/edit.blade.php ENDPATH**/ ?>