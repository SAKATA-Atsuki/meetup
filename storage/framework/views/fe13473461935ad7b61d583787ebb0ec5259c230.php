...
<body>
    ...
    <div class="admin_check_content">
        <form action="<?php echo e(route('admin.message.delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>メッセージ削除</h1>
            <p>本当に削除しますか？</p>
            <div class="button">
                ...
                <br><br>
                <a href="<?php echo e(route('admin.message', ['page' => $data['page'], 'order' => $data['order']])); ?>" class="button_2">メッセージ一覧へ</a>    
            </div>    
        </form>
    </div>
</body>
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/message/delete.blade.php ENDPATH**/ ?>