...
<body>
    ...
    <div class="admin_check_content">
        <form action="<?php echo e(route('admin.circle.delete')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            <h1>サークル削除</h1>
            <p>本当に削除しますか？</p>
            <div class="button">
                ...
                <br><br>
                <a href="<?php echo e(route('admin.circle', ['page' => $data['page'], 'order' => $data['order']])); ?>" class="button_2">サークル一覧へ</a>    
            </div>    
        </form>
    </div>
</body>
</html><?php /**PATH /Applications/MAMP/htdocs/meetup/resources/views/admin/circle/delete.blade.php ENDPATH**/ ?>