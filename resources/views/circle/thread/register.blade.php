        ...
        <div class="name">
            ...
            @if (Auth::guard('freshman')->check())
                @if (count($favorite) == 0)
                    ...
                    <a href="{{ route('circle.thread.register.favorite', ['id' => $circle['id'], 'pg' => $pg, 'page' => $page]) }}" class="button_4"><i class="far fa-heart"></i></a>
                @else
                    ...
                    <a href="{{ route('circle.thread.register.unfavorite', ['id' => $circle['id'], 'pg' => $pg, 'page' => $page]) }}" class="button_4"><i class="fas fa-heart"></i></a>
                @endif
            @endif
        </div>
